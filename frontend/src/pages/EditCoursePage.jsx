...
export default function EditCoursePage() {
  ...
  // Chapter helpers (same behavior as CreateCoursePage)
  const addChapter = () => {
    ...
    <div className="admin-courses-page">
      <div className="page-header">
        <h1 className="page-title">
          Edit <span className="title-accent">Course</span>
        </h1>
        <p className="page-subtitle">Update course details and information</p>
      </div>
